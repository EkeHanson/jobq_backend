...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'username', 'email', 'first_name', 'last_name', 'phone', 'location', 'is_active', 'is_suspended', 'suspension_reason', 'suspended_at', 'is_2fa_enabled', 'date_joined', 'last_login', 'is_staff', 'is_superuser', 'is_staff_poster', 'email_notifications', 'push_notifications', 'weekly_summary', 'allow_data_collection']
        extra_kwargs = {
